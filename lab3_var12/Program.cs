/* Паралельна програма для пошуку медіани варіаційного ряду довжини n
 * Без використання синхронізованих колекцій
 * Порівнюється час послідовної та паралельної версій, обчислюється прискорення
 */
